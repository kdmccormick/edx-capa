...
class TextInputHintsTest(HintTest):
    ...
    def test_tracking_log(self):
        ...
        self.problem.capa_module.runtime.track_function.assert_called_with(
            "edx.problem.hint.feedback_displayed",
            {
                ...
                "hints": [
                    {
                        "text": "The red light is scattered by water molecules leaving only blue light."
                    }
                ],
            },
        )
    ...
    @data(
        ...
        {"problem_id": u"1_2_1", u"choice": u"Mexico", "expected_string": ""},
        {
            "problem_id": u"1_2_1",
            u"choice": u"USAΩ",
        ...
        {"problem_id": u"1_2_1", u"choice": u"uSAxΩ", "expected_string": u""},
        {
            "problem_id": u"1_2_1",
            u"choice": u"NICKLANDΩ",
        ...
        {"problem_id": u"1_3_1", u"choice": u"b", "expected_string": u""},
    )
    @unpack
    ...
    @data(
        {
            ...
            "choice": "abc",
            "expected_string": "",
        },  # wrong answer yielding no hint
        {
            "problem_id": u"1_5_1",
            "choice": "A",
            "expected_string": u'<div class="feedback-hint-correct"><div class="explanation-title">Answer</div><span class="hint-label">Woo Hoo </span><div class="hint-text">hint1</div></div>',
        },
        {
            "problem_id": u"1_5_1",
            "choice": "a",
        ...
        },
        {
            "problem_id": u"1_5_1",
            "choice": "B",
            "expected_string": u'<div class="feedback-hint-correct"><div class="explanation-title">Answer</div><div class="hint-text">hint2</div></div>',
        },
        {
            "problem_id": u"1_5_1",
            "choice": "b",
        ...
        },
        {
            "problem_id": u"1_5_1",
            "choice": "C",
            "expected_string": u'<div class="feedback-hint-incorrect"><div class="explanation-title">Answer</div><div class="hint-text">hint4</div></div>',
        },
        {
            "problem_id": u"1_5_1",
            "choice": "c",
        ...
        # regexp cases
        {
            "problem_id": u"1_5_1",
            "choice": "FGGG",
            "expected_string": u'<div class="feedback-hint-incorrect"><div class="explanation-title">Answer</div><div class="hint-text">hint6</div></div>',
        },
        {
            "problem_id": u"1_5_1",
            "choice": "fgG",
...
class TextInputExtendedHintsCaseSensitive(HintTest):
    ...
    @data(
        {"problem_id": u"1_6_1", "choice": "abc", "expected_string": ""},
        {
            "problem_id": u"1_6_1",
            "choice": "A",
            "expected_string": u'<div class="feedback-hint-correct"><div class="explanation-title">Answer</div><span class="hint-label">Correct: </span><div class="hint-text">hint1</div></div>',
        },
        {"problem_id": u"1_6_1", "choice": "a", "expected_string": u""},
        {
            "problem_id": u"1_6_1",
            "choice": "B",
            "expected_string": u'<div class="feedback-hint-correct"><div class="explanation-title">Answer</div><span class="hint-label">Correct: </span><div class="hint-text">hint2</div></div>',
        },
    ...
    def test_tracking_log(self):
        ...
        self.problem.capa_module.runtime.track_function.assert_called_with(
            "edx.problem.hint.feedback_displayed",
            {
                ...
                "hints": [
                    {"text": "The square root of two turns up in the strangest places."}
                ],
            },
        )
        ...
        self.problem.capa_module.runtime.track_function.assert_called_with(
            "edx.problem.hint.feedback_displayed",
            {
                ...
                "hints": [
                    {
                        "text": "A true",
                        "trigger": [{"choice": "choice_0", "selected": True}],
                    }
                ],
        ...
        self.problem.capa_module.runtime.track_function.assert_called_with(
            "edx.problem.hint.feedback_displayed",
            {
                ...
                "hints": [
                    {
                        "text": "A false",
                        "trigger": [{"choice": "choice_0", "selected": False}],
                    },
                    {
                        "text": "C true",
                        "trigger": [{"choice": "choice_2", "selected": True}],
                    },
                ],
                "question_type": "choiceresponse",
            },
                ...
                "hints": [
                    {
                        "text": "A C Compound",
                        "trigger": [
                            {"choice": "choice_0", "selected": True},
                            {"choice": "choice_2", "selected": True},
                        ],
                    }
                ],
                "question_type": "choiceresponse",
    ...
    def test_tracking_log(self):
        ...
        self.problem.capa_module.runtime.track_function.assert_called_with(
            "edx.problem.hint.feedback_displayed",
            {
                ...
                "hints": [
                    {"text": 'Mushroom <img src="#" ale="#"/>is a fungus, not a fruit.'}
                ],
            },
        )
...
class DropdownHintsTest(HintTest):
    ...
    @data(
        ...
        {"problem_id": u"1_4_1", "choice": "not going to match", "expected_string": ""},
    )
    @unpack
...
class ErrorConditionsTest(HintTest):
    ...
    def test_error_conditions_illegal_element(self):
        ...
        with self.assertRaises(Exception):
            new_loncapa_problem(
                xml_with_errors
            )  # this problem is improperly constructed
