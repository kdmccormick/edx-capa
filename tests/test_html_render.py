...
class CapaHtmlRenderTest(unittest.TestCase):
    ...
    def test_include_html(self):
        ...
        self._create_test_file(u"test_include.xml", u"<test>Test include</test>")
    ...
    def test_render_response_xml(self):
        ...
        the_system.render_template.return_value = (
            "<div class='input-template-render'>Input Template Render</div>"
        )
        ...
        solution_element = rendered_html.xpath('//div[@class="input-template-render"]')[
            0
        ]
        ...
        self.assertEqual(the_system.render_template.call_args_list, expected_calls)
