...
class TemplateTestCase(unittest.TestCase):
    ...
    def assert_has_xpath(self, xml_root, xpath, context_dict, exact_num=1):
        ...
        """
        message = (
            "XML does not have %d match(es) for xpath '%s'\nXML: %s\nContext: %s"
    ...
    def assert_label(self, xpath=None, aria_label=False):
        ...
        for label in labels:
            ...
            if aria_label:
                self.assert_has_xpath(
                    xml, "//*[@aria-label='%s']" % label["expected"], self.context
                )
            else:
...
class ChoiceGroupTemplateTest(TemplateTestCase):
    ...
    def test_problem_marked_correct(self):
        ...
        self.assert_no_xpath(
            xml, "//label[@class='choicegroup_incorrect']", self.context
        )
    ...
    def test_problem_marked_incorrect(self):
        ...
        for test_conditions in conditions:
            ...
            xml = self.render_to_xml(self.context)
            xpath = (
                "//div[@class='indicator-container']/span[@class='status incorrect']"
            )
            self.assert_has_xpath(xml, xpath, self.context)
            ...
            self.assert_no_xpath(
                xml, "//label[@class='choicegroup_correct']", self.context
            )
    ...
    def test_problem_marked_unsubmitted(self):
        ...
        for test_conditions in conditions:
            ...
            xml = self.render_to_xml(self.context)
            xpath = (
                "//div[@class='indicator-container']/span[@class='status unanswered']"
            )
            self.assert_has_xpath(xml, xpath, self.context)
    ...
    def test_never_show_correctness(self):
        ...
        for test_conditions in conditions:
            ...
            self.assert_has_text(
                xml, "//div[@class='capa_alert']", self.context["submitted_message"]
            )
...
class MathStringTemplateTest(TemplateTestCase):
    ...
    def test_math_string_inline(self):
        ...
        self.assert_has_text(
            xml, xpath, "[mathjaxinline]y = ax^2 + bx + c[/mathjaxinline]"
        )
...
class OptionInputTemplateTest(TemplateTestCase):
    ...
    def test_select_options(self):
        ...
        # Create options 0-4, and select option 2
        self.context["options"] = [
            (id_num, "Option {0}".format(id_num)) for id_num in range(5)
        ]
...
class DragAndDropTemplateTest(TemplateTestCase):
    ...
    def test_status(self):
        ...
        for (input_status, expected_css_class, expected_text) in test_cases:
            ...
            xpath = "//span[@class='status {0}']/span[@class='sr']".format(
                expected_css_class
            )
...
class ChoiceTextGroupTemplateTest(TemplateTestCase):
            ...
            (
                ...
                [
                    {"tail_text": "", "type": "text", "value": "", "contents": ""},
                    {
                        ...
                        "type": "textinput",
                        "value": "",
                        "contents": "choiceinput_0_textinput_0",
                    },
                ],
            ),
            (
                ...
                [
                    {"tail_text": "", "type": "text", "value": "", "contents": ""},
                    {
                        ...
                        "type": "textinput",
                        "value": "",
                        "contents": "choiceinput_1_textinput_0",
                    },
                ],
            ),
        ]
    ...
    def test_problem_marked_correct(self):
        ...
        # Should NOT mark individual options
        self.assert_no_xpath(
            xml, "//label[@class='choicetextgroup_incorrect']", self.context
        )

        self.assert_no_xpath(
            xml, "//label[@class='choicetextgroup_correct']", self.context
        )
    ...
    def test_problem_marked_incorrect(self):
        ...
        conditions = [
            {"status": Status("incorrect"), "input_type": "radio", "value": {}},
            {
                "status": Status("incorrect"),
                "input_type": "checkbox",
                "value": self.WRONG_CHOICE_CHECKBOX,
            },
            {
                "status": Status("incorrect"),
                "input_type": "checkbox",
                "value": self.BOTH_CHOICE_CHECKBOX,
            },
            {
                "status": Status("incorrect"),
                "input_type": "checkbox",
...
class CodeinputTemplateTest(TemplateTestCase):
    ...
    def test_editor_exit_message(self):
        ...
        self.assert_has_text(
            xml,
            '//span[@id="cm-editor-exit-message-1"]',
            self.context["code_mirror_exit_message"],
        )
